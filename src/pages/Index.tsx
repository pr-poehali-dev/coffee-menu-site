...
const menuData = {
  coffee: [
    { name: 'Капучино', description: 'Классический итальянский капучино с нежной молочной пенкой', price: 180 },
    { name: 'Капучино с корицей', description: 'Классический капучино с ароматной корицей и сливками', price: 200 },
    { name: 'Шоколадный капучино', description: 'Капучино с бельгийским шоколадом и взбитыми сливками', price: 230 },
    { name: 'Эспрессо', description: 'Крепкий ароматный эспрессо', price: 150 },
    { name: 'Американо', description: 'Классический американо на основе двойного эспрессо', price: 160 },
    { name: 'Латте', description: 'Нежный кофе с молоком и воздушной пенкой', price: 200 },
  ...
  cocktails: [
    { name: 'Банановый коктейль', description: 'Густой молочный коктейль со спелым бананом и сливками', price: 240 },
    { name: 'Шоколадный коктейль', description: 'Насыщенный коктейль с бельгийским шоколадом и мороженым', price: 260 },
